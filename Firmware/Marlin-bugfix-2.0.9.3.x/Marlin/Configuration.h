...
#define STRING_CONFIG_H_AUTHOR "JE Kim" // Who made the changes.
...
// 독립적인 노즐을 여러개 사용할 때 안 쓰는 하나를 어떻게 처리할지 
 ...
 *
 * Enable and connect the power supply to the PS_ON_PIN. (PE11)
